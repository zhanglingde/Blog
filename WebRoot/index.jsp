...
<body>
    ...
    <div>
    	<p align="center">
						<a href="ArticleServlet?flag=queryallarticle&page=1">首页</a> 
						<a	href="ArticleServlet?flag=queryallarticle&page=${requestScope.lastpage} ">上一页</a>
						<script>
							//显示具体的页数的列表
							...
							if (num != "" && page != "") {
								...
								for (var i = 1; i <= num; i++) {
									if (i == page) {
										//显示具体的页数，且当前的页数为红色
										document.write("<a style='color:red' href='ArticleServlet?flag=queryallarticle&page="+ i+ "'>"+ i+ "</a>&nbsp;&nbsp;");
									} else {
										document.write("<a href='ArticleServlet?flag=queryallarticle&page="+ i+ "'>"+ i+ "</a>&nbsp;&nbsp;");
									}
								}
							}
						</script>
						<a href="ArticleServlet?flag=queryallarticle&page=${requestScope.nextpage} ">下一页</a>
						<a href="ArticleServlet?flag=queryallarticle&page=${requestScope.pagenum }">末页</a>
