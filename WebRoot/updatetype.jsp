         ...
         <div class="left" id="learn">
           ...
           <div class="l_content"> 
	           <form action="TypeServlet" method="post" style="height:270px">
	           		<input type="hidden" name="flag" value="updatetype">
	           		<label class="layui-form-label">文章类型：</label>
	           		<input class="layui-input" type="text" name="type" value="${requestScope.type.type_name }"><br>
	           		<input type="hidden" name="typeid" value="${requestScope.type.type_id }">
	           		
	           		<input class="layui-btn" type="submit" value="修改"><br>
	           </form>        
